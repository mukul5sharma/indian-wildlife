...
<head>
	...
	<title>Indian Wildlife-Profile</title>
	<style type="text/css">
	.header_table{
	...
	<%
		...
		out.println(session.getAttribute("fullname"));
		 ...
		 %></td>
						...
						<jsp:scriptlet>if(request.getAttribute("profileuploaded")!=null){if(request.getAttribute("profileuploaded").equals(true)){ </jsp:scriptlet>
						<table>
							<tr>
							
								<td colspan="2" class="profile_top_head">Change Profile Stamp:</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="profile_top_head">First Name:</td>
								<td class="profile_top_head">Last Name:</td>
							</tr>
							<tr>
								<td class="profile_top_head">
									<input name="firstname" type="text" value="" style="height:23px; width:210px; color:#4e9258; border:2px #659EC7 solid;" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" />
								</td>
								<td class="profile_top_entries">
									<input name="lastname" type="text" value="" style="height:23px; width:210px; color:#4e9258; border:2px #659EC7 solid;" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" />
								</td>
							</tr>
							<tr>
								<td class="profile_top_head">About Me:</td>
								<td class="profile_top_head">My Latest Expedition:</td>
							</tr>
							<tr>
								<td class="profile_top_entries">
									<textarea name="about_me" cols="38" rows="5" style="color:#4e9258;border:2px #659EC7 solid;"></textarea>
								</td>
								<td class="profile_top_entries">
									<textarea name="expedition" cols="38" rows="5" style="color:#4e9258;border:2px #659EC7 solid;"></textarea>
								</td>
							</tr>
							<tr>
								<td class="profile_top_head">Last School I Attended:</td>
								<td class="profile_top_head">Qualification:</td>
							</tr>
							<tr>
								<td class="profile_top_entries">
									<input name="last_school" type="text" value="" style="height:23px; width:210px; color:#4e9258; border:2px #659EC7 solid;" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" />
								</td>
								<td>
									<select name="qualification" class="profile_select_option">
										<option disabled="disabled" selected="selected"></option>
										<option value="I am Scientist" >I am Scientist</option>
										<option value="Done my Doctoral" >Done my Doctoral</option>
										<option value="Done my Masters" >Done my Masters</option>
										<option value="Done my Graduation" >Done my Graduation</option>
										<option value="Dome my Grade 12" >Dome my Grade 12</option>
									</select>
									
								</td>
							</tr>
							<tr>
								<td class="profile_top_head">Employer:</td>
								<td class="profile_top_head">Since:</td>
							</tr>
							<tr>
								<td class="profile_top_entries">
									<input name="employer" type="text" value="" style="height:23px; width:210px; color:#4e9258; border:2px #659EC7 solid;" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" />
								</td>
								<td>
									<select name="since_month" class="profile_select_option">
										<option disabled="disabled" selected="selected"></option>
									...
									<input name="since_day" type="text" value="" style="height:23px; width:50px; color:#4e9258; border:2px #659EC7 solid;" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" />
								</td>
							</tr>
							<tr>
								<td class="profile_top_head">Address:</td>
								<td class="profile_top_head">Mobile Phone:</td>
							</tr>
							<tr>
								<td class="profile_top_head">
									<input name="address" type="text" value="" style="height:23px; width:325px; color:#4e9258; border:2px #659EC7 solid;" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" />
								</td>
								<td class="profile_top_entries">
									<input name="mobileno" type="text" value="" style="height:23px; width:210px; color:#4e9258; border:2px #659EC7 solid;" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" />
								</td>
							</tr>
							<tr>
								<td class="profile_top_head">Birthday</td>
								<td class="profile_top_head">Username:</td>
							</tr>
							<tr>
								<td class="profile_top_head">
									<select name="month" class="profile_select_option">
									...
									<input name="day" type="text" value="" style="height:23px; width:50px; color:#4e9258; border:2px #659EC7 solid;" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" /> ,
									<input name="year" type="text" value="" style="height:23px; width:50px; color:#4e9258; border:2px #659EC7 solid;" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" />
								</td>
								<td class="profile_top_entries">
									<input name="username" type="text" value="" style="height:23px; width:210px; color:#4e9258; border:2px #659EC7 solid;" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" />
								</td>
							</tr>
							<tr>
								<td colspan="2">
