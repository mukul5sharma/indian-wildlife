	...
	<tr>
		...
		out.println(session.getAttribute("fullname"));
		 ...
		 %></td>
							...
							<tr>
								<td colspan="3">
									<input type="submit" name="button" class="newsletter_button" value="Read Latest Realize"/>
									<input type="submit" name="button" class="newsletter_button" value="Read Previous Realize"/>
								</td>
							</tr>
							<tr>
							<td colspan="3" >
							...
							{
							if(request.getAttribute("view").equals(false))
							{
							out.println("No Newsletter Released yet!");
							}
							}
							%>
							</td>
