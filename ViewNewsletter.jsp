...
%>
<%@page import="beans.Newsletters"%>
<%@page import="java.util.Iterator"%>
<jsp:useBean id="view" class="beans.ViewNewsletterBean" scope="request" />
...
<head>
	...
	<title>Indian Wildlife-Newsletters</title>
	<style type="text/css">
	.header_table{
	...
	<tr>
		...
		<form action="CheckUserActivity" method="post" >
			<table align="center" class="profile_menu_table">
				<tr>
					...
					<hr/><input name="button" type="submit" value="Settings" class="profile_menu"/>
		...
		<td valign="top" width="auto" style="background-color:#EBF0F9;">
			<table align="left">
				<tr>
					<td>
					<form action="ViewNewsletterAction" method="post" >
						<table width="650px">
							<tr>
								<td width="40px">
		...
		out.println(session.getAttribute("fullname"));
		 ...
		 %></td>
							...
							<td colspan="3" >
							<%
							if(request.getAttribute("viewlatest")!=null)
							{
							if(request.getAttribute("viewlatest").equals(true))
							{
							%>
							<table width="650px" >
							<tr>
							...
							<tr>
							<td colspan="2" >
							<jsp:getProperty property="subject" name="view"/>
							</td>
							</tr>
							<tr>
							<td>
							...
							<tr>
							<td colspan="2" >
							<jsp:getProperty property="content" name="view"/>
							</td>
							</tr>
							<tr>
							<td style="width: 153px; ">
							<div class="forum_labels" >Released On:</div>
							</td>
							<td>
							<jsp:getProperty property="date" name="view"/>
							</td>
							</tr>
							</table>
							<%
							...
							{
							Iterator it=view.getNewsletter().iterator();
							while(it.hasNext())
							{
							Newsletters newsletters=(Newsletters)it.next();
							%>
							<table width="650px" >
							<tr>
							<td>
