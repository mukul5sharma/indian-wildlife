	...
	<%
		...
		out.println(session.getAttribute("fullname"));
		 ...
		 %></td>
							...
							<tr>
								<td colspan="3">
									<form action="SearchProcessAction" method="post" >
									<table>
										<tr>
											<td>
											Enter Name&nbsp;<input name="keyword" type="text" />&nbsp;<select name="type" ><option disabled="disabled" selected="selected" ></option><option value="flora" >Flora</option><option value="fauna" >Fauna</option></select>&nbsp;<input type="submit" value="Search" class="forum_button" />
											</td>
										</tr>
									</table>
									</form>
							...
							{
								if(request.getAttribute("searchfound").equals(false))
								{
