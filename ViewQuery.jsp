...
<%@page import="beans.ViewQuery"%>
<jsp:useBean id="view" class="beans.VewQueryBean" scope="request" />
...
<title>Indian Wildlife-View Query</title>
<style type="text/css">
.header_table{
...
<table width="1024px" align="center" class="header_table">
	...
	<img align="top" src="RetrieveSiteImage.jsp?imgid=2" alt="" style="height: 105px; width: 368px"/>
		...
		<%
		if
		((session.getAttribute("fullname")!=null) && (session.getAttribute("usertype").equals("reviewer")))
		{
...
<!--MENU-->
<form action="ViewQueryAction" method="post" >
<table width="100%" class="admin_menu_table">
	<tr>
		<td width="auto">&nbsp;</td>
		<td width="1024px" align="center" height="50px">
			<input type="button" onclick="parent.location='index.jsp'" class="admin_menu_button" name="button" value="Home"/>
			<input type="submit" class ="admin_menu_button" name="button" value="View Queries" />
		</td>
		<td width="auto">&nbsp;</td>
	</tr>
</table>
                               ...
                               <tr>
                                       <td style="width: 630px; ">
                                               ...
                                               <table width="650px" align="center">
                                                       ...
                                                       <td>
                                                       <%
														Iterator it=view.getViewquery().iterator();
														while(it.hasNext())
														{
														ViewQuery viewquery=(ViewQuery)it.next();
														
														%>
														<form action="ReplyQueryAction" method="post" >
														<table width="650px" >
														<tr>
														<td>
														Subject:
														...
														<input type="hidden" name="queryid" value="<%=viewquery.getId() %>" />
														<input type="submit" value="Reply" class="forum_button" />
														</td>
														</tr>
														</table>
														</form>
