...
%>
<jsp:useBean id="search" class="beans.SearchProcessBean" scope="request" />
		 ...
		 %></td>
							...
							<tr>
								<td colspan="3">
									<table>
										<tr>
											<td><img src="RetrieveImage.jsp?imgid=<%=search.getImgid() %>" alt="Picture" width="650px" height="300px" /></td>
										</tr>
									</table>
								</td>
							</tr>
							...
							<tr>
								<td class="profile_top_head">
									<jsp:getProperty property="name" name="search"/>
								</td>
								<td class="profile_top_entries">
									<jsp:getProperty property="sci_name" name="search"/>
								</td>
							</tr>
							<tr>
								<td class="profile_top_head">Physical Characteristics:</td>
								<td class="profile_top_head">Climatic Condition:</td>
							</tr>
							<tr>
								<td class="profile_top_entries">
									<jsp:getProperty property="phy_char" name="search"/>
								</td>
								<td class="profile_top_entries">
									<jsp:getProperty property="climatic_cond" name="search"/>
								</td>
							</tr>
							<tr>
								<td class="profile_top_head">Threats:</td>
								<td class="profile_top_head">Lifespan:</td>
							</tr>
							<tr>
								<td class="profile_top_entries">
									<jsp:getProperty property="threats" name="search"/>
								</td>
								<td>
									<jsp:getProperty property="lifespan" name="search"/>
								</td>
							</tr>
