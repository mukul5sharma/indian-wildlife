...
<title>Indian Wildlife-Reviewer Home</title>
<style type="text/css">
.header_table{
...
<table width="100%" class="admin_menu_table">
	<tr>
		...
		<td width="1024px" align="center" height="50px">
			<input type="button" class="admin_menu_button" name="button" onclick="parent.location='index.jsp'" value="Home"/>
...
<table class="body_table" style="background-color:#E0E0E0;" width="1024px" align="center">
	<tr>
		<td>
		<%if(request.getAttribute("queryreplied")!=null)
		{
		if(request.getAttribute("queryreplied").equals(true))
		{
		out.println("The Query is replied");
		}
		else
		{
		out.println("The is not replied");
		}
		}
		 %>
		</td>
