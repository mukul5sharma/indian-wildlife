	...
	<%
		...
		out.println(session.getAttribute("fullname"));
		 ...
		 %></td>
						...
						<tr>
						<td colspan="2" style="height: 26px; width: 303px">
						<a href="SubmitQuery.jsp" class="forum_button" style="text-decoration: none" >
						Submit Query
						</a>
						</td>
						<td style="width: 218px; " align="right">
						<a href="ViewReply.jsp" class="forum_button" style="text-decoration: none" >
						View Reply
						</a>
						</td>
						</tr>	
