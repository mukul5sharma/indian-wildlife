...
%>
<jsp:useBean id="search" class="beans.SearchForumBean" scope="request" />
...
<head>
	...
	<title>Indian Wildlife-Forums</title>
	<style>
.header_table{
	...
	<tr>
		...
		<td valign="top" width="auto" style="background-color:#EBF0F9;">
			<table align="left">
				<tr>
					<td>
					<form action="SearchForumAction" method="post" >
						<table width="650px">
							<tr>
								<td width="40px">
	...
	<%
		...
		out.println(session.getAttribute("fullname"));
		 ...
		 %></td>
							...
							<tr>
							<td colspan="3" >
							<div class="forum_labels" >Search Forum
							...
							<tr>
							<td colspan="3" >
							<a href="ChooseForum?name=<jsp:getProperty property="forum_name" name="search"/>" >
							<jsp:getProperty property="forum_name" name="search"/>
							</a>
							<%
							}
							else
