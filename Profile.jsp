...
%>
<jsp:useBean id="checkuser" class="beans.CheckUserBean" scope="session" />
						...
						<table width="675px">
							<tr>
								<td width="100px"rowspan="6">
									<img src="RetrieveImage.jsp?imgid=<%=session.getAttribute("imgid") %>" width="100px" height="150px" alt="Profile Picture"/>
								</td>
								<td class="profile_name_heading"><jsp:getProperty property="fullname" name="checkuser" /></td>
								<td>&nbsp;</td>
								<td align="right">
									<a class="profile_button" href="EditProfile.jsp" style="text-decoration: none" >Edit Profile</a>
								</td>
							</tr>
							<tr>
								<td class="profile_top_head">Profile </td>
								<td class="profile_top_entries">wildhabitat.com/<jsp:getProperty property="username" name="checkuser"/></td>
								<td class="profile_top_entries">&nbsp;</td>
							</tr>
							<tr>
								<td class="profile_top_head">My Den </td>
								<td class="profile_top_entries"><%if(checkuser.getAddress()!=null){out.print(checkuser.getAddress());} %></td>
								<td class="profile_top_entries">&nbsp;</td>
							</tr>
							<tr>
								<td class="profile_top_head">Mail me at</td>
								<td class="profile_top_entries"><jsp:scriptlet>if(checkuser.getEmailid()!=null){out.print(checkuser.getEmailid());} </jsp:scriptlet></td>
								<td class="profile_top_entries">&nbsp;</td>
							</tr>
							<tr>
								<td class="profile_top_head">Call me on</td>
								<td class="profile_top_entries"><jsp:scriptlet>if(checkuser.getMobileno()!=0){out.print(checkuser.getMobileno());} </jsp:scriptlet></td>
								<td class="profile_top_entries">&nbsp;</td>
							</tr>
							<tr>
								<td class="profile_top_head">Birthday</td>
								<td class="profile_top_entries"><jsp:scriptlet>if(checkuser.getDay()!=0){out.print(checkuser.getDay());} </jsp:scriptlet>&nbsp;<jsp:scriptlet>if(checkuser.getMonth()!=null){out.print(checkuser.getMonth());} </jsp:scriptlet>&nbsp;<jsp:scriptlet>if(checkuser.getYear()!=0){out.print(checkuser.getYear());} </jsp:scriptlet></td>
								<td class="profile_top_entries">&nbsp;</td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="2" class="profile_top_head">About Me</td>
								<td colspan="2" class="profile_top_head">My Latest Expedition</td>
							</tr>
							<tr>
								<td colspan="2" class="profile_top_entries"><%if(checkuser.getAbout_me()!=null){out.print(checkuser.getAbout_me());} %></td>
								<td colspan="2" class="profile_top_entries"><%if(checkuser.getExpedition()!=null){out.print(checkuser.getExpedition());} %></td>
							</tr>
							<tr>
								<td colspan="2" class="profile_top_head">Last School I Attended</td>
								<td colspan="2" class="profile_top_head">Qualification</td>
							</tr>
							<tr>
								<td colspan="2" class="profile_top_entries"><%if(checkuser.getLast_school()!=null){out.print(checkuser.getLast_school());} %></td>
								<td colspan="2" class="profile_top_entries"><jsp:scriptlet>if(checkuser.getQualification()!=null){out.print(checkuser.getQualification());} </jsp:scriptlet></td>
							</tr>
							<tr>
								<td colspan="2" class="profile_top_head">Employer</td>
								<td colspan="2" class="profile_top_head">Since</td>
							</tr>
							<tr>
								<td colspan="2" class="profile_top_entries"><%if(checkuser.getEmployer()!=null){out.print(checkuser.getEmployer());} %></td>
								<td colspan="2" class="profile_top_entries"><%if(checkuser.getSince_month()!=null){out.print(checkuser.getSince_month());} %>&nbsp;<jsp:scriptlet>if(checkuser.getSince_day()!=0){out.print(checkuser.getSince_day());} </jsp:scriptlet></td>
							</tr>
							<tr>
								<td colspan="4"><hr style="height:3px; color:black;" noshade="noshade"/></td>
							</tr>
