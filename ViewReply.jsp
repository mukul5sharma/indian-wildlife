...
%>
<jsp:useBean id="view" class="beans.ViewReplyBean" scope="request" />
	...
	<%
		...
		out.println(session.getAttribute("fullname"));
		 ...
		 %></td>
							...
							<tr>
								<td colspan="3">
									<form action="ViewReplyAction" method="post" >
									<table>
										<tr>
											<td>
											Enter Query ID&nbsp;<input name="queryid" type="text" />&nbsp;<input type="submit" value="Search" class="forum_button" />
											</td>
										</tr>
										<tr>
										...
										<td>
										<%
										if(request.getAttribute("isreply")!=null)
										{
											if(request.getAttribute("isreply").equals(true))
											{
												%>
												<table>
												<tr>
												<td class="forum_labels" >
												Subject:
												</td>
												</tr>
												<tr>
												...
												<tr>
												<td>
												On:&nbsp;<jsp:getProperty property="date" name="view"/>
												<hr />
												</td>
												</tr>
												<tr>
												...
												<tr>
												<td colspan="2" >
												<jsp:getProperty property="reply" name="view"/>
												</td>
												</tr>
												</table>
												<%
