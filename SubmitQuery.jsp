...
%>
<jsp:useBean id="checkquery" class ="beans.SubmitQueryBean" scope="request"/>
	...
	<tr>
		...
		<td width="auto" valign="top" style="background-color:#EBF0F9;">
			<table align="left">
				<tr>
					<td>
						<form action="SubmitQueryAction" method="post">
						<table width="650px">
						<tr>
								<td width="40px">
		...
		out.println(session.getAttribute("fullname"));
		 ...
		 %></td>
							...
							<tr>
								...
								<td colspan="" class="profile_top_head" style="width: 204px; ">Subject</td>
								<td colspan="" > <input type="text" name="subject" style="width: 186px; "></input> </td>
							</tr>
							<tr>
								<td width="100px" class="profile_top_head">Query </td>
								<td class="profile_top_entries"> <textarea name="content" rows="10" cols="20"></textarea></td>
							</tr>
							<tr>
							...
							<tr>
								<td></td>
								<td class="profile_top_entries"><input type="submit" value="Submit" class="forum_button" /></td>
							</tr>
							<tr>
								<td colspan="3"><hr style="height:3px; color:black;" noshade="noshade"/></td>
							</tr>
							<tr>
								<td colspan="3">
									<table>
										<tr>
											<td><% if(request.getAttribute("querysubmitted") != null)
											{ 
											if(request.getAttribute("querysubmitted").equals(true))
											  { out.println("your query is submitted Query Id=");%>
											  <jsp:getProperty property="query_id" name="checkquery"/>
											<%
											 } } %> 
											 </td>
										</tr>
